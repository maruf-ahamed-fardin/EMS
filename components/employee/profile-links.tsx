import type { TeamProfileLink, TeamProfileLinkKind } from '@/lib/validations';
import { Globe } from 'lucide-react';
import { DiscordIcon, FacebookIcon, GithubIcon, InstagramIcon, LinkedinIcon } from '@/components/employee/brand-icons';
import { cn } from '@/lib/utils/cn';

/**
 * Only these kinds exist, so every link renders as a known icon and nothing unrecognised can
...
export const LINKS: Record<TeamProfileLinkKind, { icon: Icon; label: string; className: string }> = {
  ...
  DISCORD: { icon: DiscordIcon, label: 'Discord', className: 'bg-[#eef0fe] text-[#4752c4] dark:bg-[#5865f2]/15 dark:text-[#a5acff]' },
