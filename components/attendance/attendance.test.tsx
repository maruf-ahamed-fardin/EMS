import type { AttendanceItem, MyAttendanceToday } from '@/lib/validations';
import { fireEvent, render, screen, waitFor } from '@testing-library/react';
import { ApiRequestError } from '@/lib/client/api-error';
import { attendanceHref, formatDuration, formatTime, toClockInput } from '@/lib/client/attendance';
