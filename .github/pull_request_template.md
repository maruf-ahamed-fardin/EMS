...
- [ ] New permissions are in the catalogue in `apps/web/contracts` and given to the right roles
- [ ] Writes are audited
- [ ] New configuration goes through `apps/web/server/src/config/env.ts`, and errors name the variable,
      never its value
