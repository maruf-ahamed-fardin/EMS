import { DEFAULT_ROLE_GRANTS } from '@/lib/validations';
import { auditView } from '@/lib/services/audit/redaction';
import { generateToken, hashToken, safeEqual } from '@/lib/http/security/tokens';
import type { AuthContext } from '@/lib/auth/auth-context';
import { checkCsrf, type CsrfRequest } from '@/lib/auth/guards/csrf.guard';
import { accountTracker, throttleTracker } from '@/lib/auth/guards/throttler.guard';
import { checkPassword } from '@/lib/auth/password-policy';
import { ScopeService } from '@/lib/auth/scope.service';
import { SESSION_IDLE_MS, sessionState, shouldTouch } from '@/lib/auth/session-policy';
