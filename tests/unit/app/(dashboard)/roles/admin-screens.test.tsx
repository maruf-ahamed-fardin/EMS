import type { PermissionItem, RoleItem, UserListItem } from '@/lib/validations';
import { fireEvent, render, screen, waitFor } from '@testing-library/react';
import { UserActions } from '@/app/(dashboard)/users/user-dialogs';
import { changedKeys, RoleEditor } from '@/app/(dashboard)/roles/role-editor';
...
describe('UserActions', () => {
  ...
  it('shows the API’s reason when a change is refused', async () => {
    const { ApiRequestError } = await import('@/lib/client/api-error');
