import type { AttendanceTrend, DashboardOverview, SearchResults } from '@/lib/validations';
import { seedDemoActivity } from '@/prisma/demo-activity';
import { DEMO_PEOPLE } from '@/prisma/demo-data';
import { dateOnly, monthStart, zonedDate } from '@/lib/services/calendar/work-calendar';
