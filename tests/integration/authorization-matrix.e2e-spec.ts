import { DEFAULT_ROLE_GRANTS, type SystemRoleKey } from '@/lib/validations';
...
const MATRIX: Array<{ method: 'get'; path: string; expect: Expectation }> = [
  ...
  { method: 'get', path: '/users', expect: { anonymous: 401, super_admin: 200, hr_admin: 200, manager: 403, employee: 403 } },
  { method: 'get', path: '/users/form-options', expect: { anonymous: 401, super_admin: 200, hr_admin: 403, manager: 403, employee: 403 } },
