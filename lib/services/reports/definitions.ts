...
import type { ScopeService } from '@/lib/auth/scope.service';
import { addDays, dateOnly, zonedTime } from '@/lib/services/calendar/work-calendar';
import type { Prisma } from '@/lib/db/generated/prisma/client';
import { available } from '@/lib/services/leave/leave-rules';
