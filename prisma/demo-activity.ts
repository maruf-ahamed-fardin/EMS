import { type AttendanceSettings, DEFAULT_ATTENDANCE_SETTINGS } from '@/lib/validations';
import { checkInStatus, workedMinutes } from '@/lib/services/attendance/attendance-rules';
import { addDays, dateOnly, workingDaysUpTo, zonedDate, zonedTime } from '@/lib/services/calendar/work-calendar';
import { proratedAllocation } from '@/lib/services/leave/leave-rules';
